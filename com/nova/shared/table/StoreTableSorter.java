...
class StoreTableSorter {
	...
	/**
	 * Determina que las columnas no se puedan reorganizar, porque el
	 * ordenamiento se basa en el indizado de las columnas.
	 * <p>
	 * Determina el tamaño de las columnas y agrega el listener para escuchar
	 * los clicks para el ordenamiento
	 * 
	 * @param table
	...
	void updateData(int column) {
		model.update(model.getColumnName(column),
	 ...
	 * @author Camilo
	 * @version 1.1 Optimizado y adecuado para la aplicacion
	 */
