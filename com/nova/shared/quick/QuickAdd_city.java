...
/**
 * Esta clase representa la interfaz de creacion rapida de una ciudad en el
 * listado de la aplicacion
 * 
 * @author Camilo Nova
 * @version 1.0 Funcionalidad Basica
 */
class QuickAdd_city extends JDialog implements QuickAdd {
	...
	/**
	 * Crea la interfaz para mostrar la entrada de nueva ciudad
	 * 
	 * @since 1.0
	 */
	public QuickAdd_city() {
