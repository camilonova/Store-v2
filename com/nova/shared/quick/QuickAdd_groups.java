...
/**
 * Esta clase representa la interfaz de creacion rapida de un grupo.
 * 
 * @author Camilo Nova
 * @version 1.0 Funcionalidad Basica
 */
class QuickAdd_groups extends JDialog implements QuickAdd {
	...
	/**
	 * Crea la interfaz para mostrar la entrada del nuevo elemento a los grupos.
	 * 
	 * @since 1.0
	 */
	public QuickAdd_groups() {
