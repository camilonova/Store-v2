 ...
 * @version 1.0
 */
public class MoneyCheckerField extends JTextField implements KeyListener {
	 ...
	 * @since 1.0
	 */
	public MoneyCheckerField(int maxDigits) {
	 ...
	 * @since 1.0
	 */
	public MoneyCheckerField(JComponent nextElement, JComponent exitElement) {
	 ...
	 * @since 1.0
	 */
	public MoneyCheckerField(int maxDigits, JComponent nextElement,
