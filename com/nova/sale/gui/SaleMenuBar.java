 ...
 */
public class SaleMenuBar extends JMenuBar {
	 ...
	 */
	private JMenuItem nuevoItm = new JMenuItem("Nueva Factura",
			GlobalConstants.NEW_ICON_BIG);

	/**
	 * Item de ver factura
	 */
	private JMenuItem verItm = new JMenuItem("Ver Factura",
	 ...
	 *            Modulo propietario
	 */
	public SaleMenuBar(Modules own) {
		owner = own;
		...
		nuevoItm.setToolTipText("Crear una nueva factura");
		...
		verItm.setToolTipText("Ver la factura seleccionada");
