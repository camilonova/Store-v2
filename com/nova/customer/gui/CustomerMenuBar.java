...
public class CustomerMenuBar extends JMenuBar {
	 ...
	 */
	private JMenuItem nuevoItm = new JMenuItem("Nuevo Cliente",
	 ...
	 */
	private JMenuItem borrarItm = new JMenuItem("Borrar Cliente",
	 ...
	 *            Modulo propietario
	 */
	public CustomerMenuBar(Modules own) {
		owner = own;
		...
		nuevoItm.setToolTipText("Crear un cliente nuevo");
		...
		editarItm.setToolTipText("Editar el cliente seleccionado");
		...
		borrarItm.setToolTipText("Borrar el cliente seleccionado");
