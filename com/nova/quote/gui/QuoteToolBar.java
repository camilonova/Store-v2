 ...
 */
public class QuoteToolBar extends JToolBar {
	 ...
	 * @since 1.0
	 */
	public QuoteToolBar(Modules own) {
		owner = own;
		comando = owner.getCommand();

		nuevoBtn.setToolTipText("Crea una nueva cotizacion");
		...
		verBtn.setToolTipText("Ver una cotizacion");
